<div class="page-header md-shadow-z-1-i navbar navbar-fixed-top">
    <div class="page-header-inner container">
        ...
        <div class="page-actions">
            @if (auth()->user() && (auth()->user()->hasAnyRole([ 'admin', 'super', 'country_manager' ]) ))
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        @if (auth()->user() && (auth()->user()->hasAnyRole([ 'admin', 'super']) ))
                            <li>
            ...
            @endif
            <a href="/chat/next" class="btn btn-primary">Take Chat</a>
            &nbsp;
