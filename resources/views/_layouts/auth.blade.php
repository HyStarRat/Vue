...
<body id="body" class="page-md page-boxed page-header-fixed page-container-bg-solid page-sidebar-closed-hide-logo page-sidebar-fixed">
    ...
    <div class="container">
        ...
        @if(auth()->user()->hasAnyRole(['admin', 'super', 'country_manager']))
            ...
            <user-form-modal title="User" target="userFormModal">
                <user-form slot="content" :auth="{{auth()->user()  }}"></user-form>
                <div slot="modal-footer" class="modal-footer">
    ...
    <script  type="text/javascript" src="/assets/globals/js/metronic.js" type="text/javascript"></script>
    <script type="text/javascript" src="/assets/admin/js/layout.js" type="text/javascript"></script>
