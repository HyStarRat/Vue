...
class ChatController extends Controller
{
    ...
    public function conversation(Website $website, $conversation_id)
    {
        ...
        $conversation = $conversation->merge([
            'global_notes' => Note::where('user_id', $conversation['interlocutor']->id )->first(),
            'inter' => $conversation['interlocutor'],
        ]);
    ...
    {
        $conversation = Conversation::with('interlocutor.profile')
        ...
        if($request->global)
            $data['user_id'] = $conversation['interlocutor']->id;
