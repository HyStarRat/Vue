		...
		<div v-for="website in websites" class="col-md-3">
			<div class="portlet light profile-sidebar-portlet website-list">
				...
				<div class="profile-userbuttons"  >
					<a data-target="#editWebsiteModal" data-toggle="modal"  class="btn btn-circle green-haze btn-sm"
						v-if="(auth.is_super || auth.is_admin)"
						@click="edit(website)" href="#" >Manage</a>
